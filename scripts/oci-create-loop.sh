...
OCI_CONNECTION_TIMEOUT_SECONDS="${OCI_CONNECTION_TIMEOUT_SECONDS:-30}"
OCI_READ_TIMEOUT_SECONDS="${OCI_READ_TIMEOUT_SECONDS:-180}"
...
OCI_CMD=(
    ...
    --profile "$OCI_PROFILE"
    --connection-timeout "$OCI_CONNECTION_TIMEOUT_SECONDS"
